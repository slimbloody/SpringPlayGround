...
import com.slim.basic.spring.mvc.beans.RootBean1;
...
public class MyImportBeanDefinitionRegistrar1 implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        boolean hasImportBean1 = registry.containsBeanDefinition("com.slim.basic.spring.mvc.beans.ImportBean1");
        boolean hasImportBean2 = registry.containsBeanDefinition("com.slim.basic.spring.mvc.beans.ImportBean2");
